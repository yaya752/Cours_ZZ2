...
Forme::Forme(Point p1,int h1, int w1):w{w1},h{h1},p{p1}
{ 
    setId();
    compteur++;
}

Forme::Forme():w{0},h{0},p{Point{0,0}}
{
    setId();
    compteur++;
}
Forme::Forme(Point p1, COULEURS couleur1):w{0},h{0},p{p1},couleur{couleur1}
{
  setId();
  compteur++;
}
